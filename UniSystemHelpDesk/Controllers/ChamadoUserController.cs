...
namespace UniSystemHelpDesk.Controllers
{
    ...
    public class ChamadoUserController : Controller
    {
        ...
        // POST: ChamadoUser/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "ID_CHAMADO,CHAMADO,DATA_CRIACAO_CHAMADO,DATA_INICIO_SUPORTE,DATA_FINALIZACAO_CHAMADO,SOLUCAO,COMENTARIOS,ID_USUARIOS_RESP,ID_EQUIPAMENTO,ID_STATUS_CHAMADO,ID_TECNICO")] US_CHAMADOS uS_CHAMADOS)
        {
            ...
            ViewBag.ID_TECNICO = new SelectList(db.US_TECNICO, "ID_TECNICO", "TECNICO", uS_CHAMADOS.ID_TECNICO);
            ViewBag.ID_USUARIOS_RESP = new SelectList(db.US_USUARIOS, "ID_USUARIOS", "NOME_USUARIO", uS_CHAMADOS.ID_USUARIOS_RESP);
            return View(uS_CHAMADOS);
        }

        // GET: ChamadoUser/Edit/5
        ...
        // POST: ChamadoUser/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_CHAMADO,CHAMADO,DATA_CRIACAO_CHAMADO,DATA_INICIO_SUPORTE,DATA_FINALIZACAO_CHAMADO,SOLUCAO,COMENTARIOS,ID_USUARIOS_RESP,ID_EQUIPAMENTO,ID_STATUS_CHAMADO,ID_TECNICO")] US_CHAMADOS uS_CHAMADOS)
        {
            if (ModelState.IsValid)
            {
